...
if __name__ == '__main__':
    ...
    #         class_label_dict[scan_idx]=class_labels.tolist()
    #     output_file_path = "class_label_dict.txt"
    #     with open(output_file_path, 'w') as file:
    #         json.dump(class_label_dict, file)
    #     print("The class_label_dict is save now")
    #     sys.exit(233)
